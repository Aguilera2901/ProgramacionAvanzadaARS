...
// Ejemplo de Objetos JTextField y JPasswordField

public class E11_5 extends JFrame {
    ...
    // El constructor de E11_5 agrega objetos JTextField a JFrame
    public E11_5(){
    ...
    private class ManejadorCampoTexto implements ActionListener{
        ...
        public void actionPerformed( ActionEvent evento ){
            ...
            else if ( evento.getSource() == campoContrasenia ) cadena = String.format( "campoContrasenia: %s", new String( campoContrasenia.getPassword() ) );
