...
public class E11_13 extends JFrame{
    ...
    // El constructor de MarcoRastreadorRaton establece la GUI y registra los manejadores de eventos de ratón
    public E11_13(){
        ...
        add( barraEstado, BorderLayout.SOUTH ); // agrega etiqueta a JFrame crea y registra un componente de escucha para los eventos de ratón y de sumovimiento
    ...
    private class ManejadorRaton implements MouseListener, MouseMotionListener{
        ...
        public void mouseExited( MouseEvent evento ){
            ...
            barraEstado.setText( "Raton fuera de JPanel" ); panelRaton.setBackground( Color.WHITE );
